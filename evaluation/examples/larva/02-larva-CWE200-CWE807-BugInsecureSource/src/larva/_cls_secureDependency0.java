...
try{
pw = new PrintWriter("/home/sven/Documents/git/gravity/implementation/org.gravity.umlsecrt/evaluation/examples/larva/02-larva-CWE200-CWE807-BugInsecureSource/src//output_secureDependency.txt");
...
if (0==1){}
		...
		if (1==0){}
		else if ((_occurredEvent(_event,25/*exitMethod*/))){
		stack .pop ();

		_state_id_secureDependency = 1;//moving to state ok
		_goto_secureDependency(_info);
		}
		else if ((_occurredEvent(_event,12/*enterMethod*/)) && (!checkSecureDependency (stack .peek (),id ))){
...
System .exit (-1 );
		...
		else if ((_occurredEvent(_event,12/*enterMethod*/))){
