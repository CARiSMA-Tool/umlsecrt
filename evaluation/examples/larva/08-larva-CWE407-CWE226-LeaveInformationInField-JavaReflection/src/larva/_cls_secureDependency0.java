...
int _state_id_secureDependency;
 ...
 public Map <String ,Collection <String >>integrityMap =readSecurityLevels ("integrity.json");
...
try{
pw = new PrintWriter("/home/sven/Documents/git/gravity/implementation/org.gravity.umlsecrt/evaluation/examples/larva/08-larva-CWE407-CWE226-LeaveInformationInField-JavaReflection/src//output_secureDependency.txt");
...
if (0==1){}
		...
		if (1==0){}
		else if ((_occurredEvent(_event,13/*exitMethod*/))){
		stack .pop ();

		_state_id_secureDependency = 1;//moving to state ok
		_goto_secureDependency(_info);
		}
		else if ((_occurredEvent(_event,6/*enterMethod*/)) && (!checkSecureDependency (stack .peek (),id ))){
...
System .exit (-1 );
		...
		else if ((_occurredEvent(_event,6/*enterMethod*/))){
		_cls_secureDependency0.pw .println ("Push: "+id );
stack .push (id );
