...
try{
pw = new PrintWriter("/home/sven/Documents/git/gravity/implementation/org.gravity.umlsecrt/evaluation/examples/larva/08-larva-CWE470-UnsafeReflection/src//output_secureDependency.txt");
...
if (0==1){}
		...
		if (1==0){}
		else if ((_occurredEvent(_event,5/*exitMethod*/))){
		stack .pop ();

		_state_id_secureDependency = 1;//moving to state ok
		_goto_secureDependency(_info);
		}
		else if ((_occurredEvent(_event,2/*enterMethod*/)) && (!checkSecureDependency (stack .peek (),id ))){
...
System .exit (-1 );
		...
		else if ((_occurredEvent(_event,2/*enterMethod*/))){
